// mengimpor berbagai komponen dan data yang dibutuhkan
...
const Home = () => {
    ...
    return (
        ...
        <FlatList
        // flatlist: menampilkan isi konten dalam format vertikal
        // mengimpor data dari datas
            data={datas}
            renderItem={renderitem}
            keyExtractor={(item) => item.id}
            // menghilangkan indikator scroll vertical 
